...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => 'Mật khẩu phải chứa ký tự viết hoa và số',
        ],
        'sale_prices' => [
            'max' => 'Giá khuyến mại phải nhỏ hơn giá bán',
        ]
    ],
